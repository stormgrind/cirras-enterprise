...
$RHQ_CLI_HOME/rhq-remoting-cli-$RHQ_CLI_VERSION/bin/rhq-cli.sh -u $RHQ_CLI_USERNAME -p $RHQ_CLI_PASSWORD -s $RHQ_SERVER_IP -t $RHQ_SERVER_PORT -f /usr/share/cirras-jon/import-servers.js >> /var/log/cirras-jon/import.log